      ...
      <ul class="sidebar-menu tree" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?= base_url('barang/tambah')?>"><i class="fa fa-circle-o"></i> Tambah Barang</a></li>
          </ul>
        </li>
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="<?= base_url('kategori/tambah')?>"><i class="fa fa-circle-o"></i> Tambah Kategori</a></li>
          </ul>
        </li>
      </ul>
    </section>
